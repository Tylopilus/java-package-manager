...
public final class JpmVersion {
    ...
    public static final String CURRENT = "0.2.0-java21";
    ...
    public static void checkJavaVersion() {
        ...
        if (version < MINIMUM_JAVA_VERSION) {
            System.err.println("Error: Java " + MINIMUM_JAVA_VERSION + "+ required (found Java " + version + ")");
            System.err.println("Please upgrade to Java " + MINIMUM_JAVA_VERSION + " or later to use JPM.");
            System.exit(1);
        }
    }
