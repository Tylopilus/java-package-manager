...
public class TestCommand extends AbstractBuildCommand {
    ...
    protected void validateProject() {
        ...
        if (!testSourceDir.exists()) {
            throw new ProjectValidationException(
                "No " + ProjectPaths.TEST_DIR + "/ directory found. Create test directory and add JUnit tests.");
        }
    }
    ...
    protected Compiler.CompileResult compile() throws Exception {
        ...
        var result = testCompiler.compileTests(testSourceDir, testOutputDir, classpath);
    ...
    private String addJUnitToClasspath(String existingClasspath) {
        ...
        var junitPlatform =
            new File(libDir, "junit-platform-console-standalone-" + JUNIT_PLATFORM_VERSION + ".jar");
