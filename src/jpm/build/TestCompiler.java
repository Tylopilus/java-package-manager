...
public class TestCompiler {
    ...
    public Compiler.CompileResult compileTests(
            File testSourceDir, File testOutputDir, String classpath) throws IOException {
        ...
        try {
            ...
            if (exitCode == 0) {
                return new Compiler.CompileResult(true, "Test compilation successful", exitCode);
            } else {
                return new Compiler.CompileResult(false, "Test compilation failed", exitCode);
            }

        } catch (InterruptedException e) {
            Thread.currentThread().interrupt();
            return new Compiler.CompileResult(false, "Test compilation interrupted", 1);
        }
    }
