...
public class Runner {
   ...
   */
  public RunResult runWithJvmArgs(
      String mainClass, File classesDir, String classpath, List<String> jvmArgs)
      throws IOException {
   ...
   * @throws IOException if execution fails
   */
  public RunResult runWithArgsAndJvmArgs(
      String mainClass, File classesDir, String classpath, String[] args, List<String> jvmArgs)
      throws IOException {
    var command = new ArrayList<String>();
    command.add("java");
  ...
  public RunResult runWithArgs(String mainClass, File classesDir, String classpath, String[] args)
      throws IOException {
    var command = new ArrayList<String>();
    command.add("java");
