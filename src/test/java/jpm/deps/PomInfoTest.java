...
class PomInfoTest {
    ...
    void shouldCalculateFullArtifactKey() {
        var pomInfo = new PomInfo("com.example", "my-artifact", "1.0.0", 
    ...
    void shouldInheritParentProperties() {
        var parent = new PomInfo("org.parent", "parent-artifact", "2.0.0",
            new HashMap<>(Map.of("inherited.prop", "parent-value")),
            new HashMap<>(), null);
        
        var child = new PomInfo("com.child", "child-artifact", "1.0.0",
    ...
    void shouldInheritManagedVersions() {
        var parent = new PomInfo("org.parent", "parent", "1.0.0",
            new HashMap<>(),
            new HashMap<>(Map.of("managed:dep", "2.0.0")),
            null);
        
        var child = new PomInfo("com.child", "child", "1.0.0",
            new HashMap<>(),
    ...
    void shouldSetParentImmutably() {
        ...
        var parent = new PomInfo("org.parent", "parent", "2.0.0",
            new HashMap<>(), new HashMap<>(), null);
    ...
    void shouldReturnUnmodifiableMaps() {
        var pomInfo = new PomInfo("com.example", "artifact", "1.0.0",
            new HashMap<>(), new HashMap<>(), null);
        
        var allProps = pomInfo.allProperties();
        
        assertThrows(UnsupportedOperationException.class, () -> 
            allProps.put("test", "value"));
    }
}
